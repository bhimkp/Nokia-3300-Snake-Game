document.addEventListener('DOMContentLoaded', () => {
    ...
    let appleIndex = 0;
    let currentSnake = [2,1,0]; // div in grid being 2 (or the HEAD) , and 0 being the end(TAIL, with all 1's being the body fro now on)
    ...
    const tail =  currentSnake.pop() // removes last item of the arraya and shows it
    ...
    function control(e){
        squares[currentIndex].classList.remove('snake'); // Removing the class of
        if(e.keyCode === 39){
